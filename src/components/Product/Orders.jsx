                ...
                <table class="table table-hover text-center mb-5">
                    <thead>
                        <tr>
                            ...
                            <DropdownMenu>
                                <DropdownItem href="/0">0</DropdownItem>
                ...
                <table className="table table-hover text-center mb-5">
                    <thead>
                        <tr>
                            ...
                            <DropdownMenu>
                                <DropdownItem href="/orders/status/0">0</DropdownItem>
                                <DropdownItem href="/orders/status/1">1</DropdownItem>
                                <DropdownItem href="/orders/status/2">2</DropdownItem>
                                <DropdownItem href="/orders/status/3">3</DropdownItem>
                                <DropdownItem href="/orders/status/4">4</DropdownItem>
                                <DropdownItem href="/orders/status/5">5</DropdownItem>
                                <DropdownItem href="/orders/status/6">6</DropdownItem>
                            </DropdownMenu>
                            </Dropdown>
                            </th>
                            <th scope="col">ACTION</th>
